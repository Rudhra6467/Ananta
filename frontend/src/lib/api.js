...
export const api = {
    ...
    changeEmail: (current_password, new_email) => client.post("/auth/change-email", { current_password, new_email }).then((r) => r.data),
    changePassword: (current_password, new_password) => client.post("/auth/change-password", { current_password, new_password }).then((r) => r.data),
